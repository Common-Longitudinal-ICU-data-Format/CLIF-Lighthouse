...
def show_hosp_qc():
    ...
    if table in st.session_state:
        ...
        # Title
        story.append(Paragraph("Hospitalization Quality Control Report", title_style))
        ...
        story.append(Paragraph(f"Total unique patients: {ttl_unique_patients}", normal_style))
